IF OBJECT_ID('sp_Get_Item_WAC_And_Qty_By_BU_Return') IS NOT NULL
    DROP PROCEDURE sp_Get_Item_WAC_And_Qty_By_BU_Return
GO

CREATE PROCEDURE sp_Get_Item_WAC_And_Qty_By_BU_Return
