...
SET SourceCSVDir=..\..\Import Files\Supplier Item Cost Refresh\SourceCSV\
SET Server=EMCTS520
SET DB=bcssa_cert2
...
SQLCmd -S %Server% -d %DB% -E -i %SQLExtractFile% -o "%SourceCSVDir%%ProcessName%-%%A.csv" -s"," -W -w 4000 -v SupplierXRefCode = "%%A" >> %LogFile%)
