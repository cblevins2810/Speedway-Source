...
IF OBJECT_ID('bc_extract_POS_Button_Template') IS NOT NULL
  DROP TABLE bc_extract_POS_Button_Template
GO

IF OBJECT_ID('bc_extract_POS_Button_Action_Frame_Group_List') IS NOT NULL
...
INTO   bc_extract_pos_button_template
...
SELECT l.*, fgt.name
INTO bc_extract_POS_Button_Action_Frame_Group_List
