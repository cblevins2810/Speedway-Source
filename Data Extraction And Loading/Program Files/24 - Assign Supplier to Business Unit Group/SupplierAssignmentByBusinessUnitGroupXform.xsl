...
<xsl:output omit-xml-declaration="yes"/>
  ...
  <InterfaceDocument InterfaceName="SupplierAssignmentImport"  Mode="Update" >
	...
	<OrgUnitIdentification OrgUnitType="BusinessUnitGroup" OrgUnitLookupValue="Code"/>
  ...
  <xsl:template name="OrgUnitList">
    <OrgUnitList>
      <xsl:for-each select="//Document/RawXMLRow">
       <OrgUnit>
	   <xsl:attribute name="OrgUnitIdentifier"><xsl:value-of select="BusinessUnitGroupName"/></xsl:attribute>
		<AssignmentList>
