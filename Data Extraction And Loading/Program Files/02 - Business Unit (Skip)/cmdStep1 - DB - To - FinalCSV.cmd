...
REM Process Business Units
SET ProcessName=Business Unit
SET ProcessCode=BusinessUnitExtract
...
SET FinalCSVDir=..\..\Import Files\Business Unit\FinalCSV\
SET Server=EMCTS520
SET DB=bcssa_cert2
...
SQLCmd -S %Server% -d %DB% -E -i %SQLExtractFile% -o "%FinalCSVDir%%ProcessName%-All Units.csv" -s"," -W -w 4000
