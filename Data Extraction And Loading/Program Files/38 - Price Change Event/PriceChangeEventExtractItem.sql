...
DELETE bcssa_custom_integration..bc_extract_price_event_item
INSERT bcssa_custom_integration..bc_extract_price_event_item

SELECT DISTINCT i.item_id, i.name, i.xref_code
FROM Item as i
