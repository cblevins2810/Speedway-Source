...
var processName = "Assign Supplier to Business Unit Group";
...
{ 
   ...
   { 
	...
	TransformXSL.load("\SupplierAssignmentByBusinessUnitGroupXform.xsl");
...
{     
	...
	domElement = objDOMDocument.createElement("BusinessUnitGroupName"); 
