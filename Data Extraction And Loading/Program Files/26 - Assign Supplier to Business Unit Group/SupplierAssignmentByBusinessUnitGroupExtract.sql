...
-- Added based on findings during extract/import testing for DEV
-- and to make conditions the same as for Supplier BU assignment extract
-- to avoid having BU Group assignments when there is no BU assignment
AND s.status_code != 'i'
-- End additional code
...
AND ((rsda.name like 'zsBUG%') or (rsda.name in (
'1 Location NY State Less NYC',
...
-- Added based on latest information on 2019/04/01
'PB~Retail Strat Connecticut',
'PB~Retail Strat Delaware',
'PB~Retail Strat Florida',
'PB~Retail Strat Georgia',
'PB~Retail Strat Illinois',
'PB~Retail Strat Indiana',
'PB~Retail Strat Kentucky',
'PB~Retail Strat Massachusetts',
'PB~Retail Strat Michigan',
'PB~Retail Strat New Hampshire',
'PB~Retail Strat New Jersey',
'PB~Retail Strat New York',
'PB~Retail Strat North Carolina',
'PB~Retail Strat Ohio',
'PB~Retail Strat Pennsylvania',
'PB~Retail Strat Rhode Island',
'PB~Retail Strat South Carolina',
'PB~Retail Strat Tennessee',
'PB~Retail Strat Virginia',
'PB~Retail Strat West Virginia',
'PB~Retail Strat Wisconsin',
'PB_F_AMY AND ALI SHANAA',
'PB_F_CRAIG SCHULTE',
'PB_F_CRAIG/BRAD HOLLAND',
'PB_F_DAN MICHAELS',
'PB_F_DAVE OLSON',
'PB_F_DAVID HASBROUCK',
'PB_F_DOUG THOMPSON',
'PB_F_ELIAS SAMAN',
'PB_F_Franchise All Store',
'PB_F_Franchise Car Wash All',
'PB_F_FRANCHISE MN ALL ',
'PB_F_FRANCHISE SD ALL',
'PB_F_FRANCHISE WI ALL',
'PB_F_GEORGE HARK',
'PB_F_HARRY BLAIR',
'PB_F_JAY CATTOOR',
'PB_F_JOHN DUCHSCHERER',
'PB_F_KEVIN AMUNDSON',
'PB_F_MARY GILMORE',
'PB_F_MICHAEL KING',
'PB_F_MIKE MCMAHON',
...
'PB_F_RICHARD KARY',
'PB_F_RON OLSON',
'PB_F_SAUMIL BRAHMBATT',
'PB_F_SHARAN SINGH',
'PB_F_STEVE DAHL',
'PB_F_STEVE SKOGLUND',
'PB_F_TOM BENSON',
'PB_F_TOM/AARON HOLTHAUS',
'PB_F_TONY AND JAY DONNER',
'PB_F_YOUSEF ABUMAYAHLEH',
'PB_FAX INCOME',
'PB_ADI FL FT MYERS-NAPLES',
'PB_ADI FL JACKSONVILLE',
'PB_ADI FL MIAMI-FT LAUDERDALE',
'PB_ADI FL ORLANDO-DAYTONA-MELBOURN',
'PB_ADI FL TAMPA-ST PETERSBURG',
'PB_ADI FL W PALM BEACH-FT PIERCE',
'PB_ADI GA ATLANTA',
'PB_ADI IN INDIANAPOLIS',
'PB_ADI IN LAFAYETTE',
'PB_ADI IN SOUTH BEND',
'PB_ADI IN TERRE HAUTE',
'PB_ADI IN-IL CHICAGO',
'PB_ADI IN-OH FT. WAYNE',
'PB_ADI KY BOWLING GREEN',
'PB_ADI KY LEXINGTON',
'PB_ADI KY-IN LOUISVILLE',
'PB_ADI MA SPRINGFIELD-HOLYOKE',
'PB_ADI MA-NH BOSTON (MANCHESTER)',
'PB_ADI MA-RI PROVIDENCE-NEW BEDFORD',
'PB_ADI MI DETROIT',
'PB_ADI MI FLINT-SAGINAW-BAY CITY',
'PB_ADI MI GRAND RAPIDS-BATTLE CREEK',
'PB_ADI MI LANSING',
'PB_ADI MI TRAVERSE CITY-CADILLAC',
'PB_ADI NC CHARLOTTE',
'PB_ADI NC GREENVILLE-WASHINGTON',
'PB_ADI NC RALEIGH-DURHAM',
'PB_ADI NC WILMINGTON',
'PB_ADI NC-SC GREENVILLE-SPARTANBURG',
'PB_ADI NC-VA GREENSBORO-WINSTON',
'PB_ADI NEW YORK, COLONY DIV',
'PB_ADI NY ALBANY-TROY',
'PB_ADI NY BINGHAMTON',
'PB_ADI NY BUFFALO',
'PB_ADI NY ELMIRA',
'PB_ADI NY ROCHESTER',
'PB_ADI NY SYRACUSE',
'PB_ADI NY UTICA',
'PB_ADI NY-CT-NJ NEW YORK',
'PB_ADI OH CLEVELAND',
'PB_ADI OH COLUMBUS',
'PB_ADI OH DAYTON',
'PB_ADI OH LIMA',
'PB_ADI OH YOUNGSTOWN',
'PB_ADI OH ZANESVILLE',
'PB_ADI OH-KY-IN CINCINNATI',
'PB_ADI OH-MI TOLEDO',
'PB_ADI OH-WV PARKERSBURG',
'PB_ADI OH-WV WHEELING-STEUBENVILLE',
'PB_ADI PA HARRISBURG-LEBANON',
'PB_ADI PA PITTSBURGH',
'PB_ADI PA WILKES BARRE-SCRANTON',
'PB_ADI PA-DE-NJ PHILADELPHIA',
'PB_ADI SC CHARLESTON',
'PB_ADI SC COLUMBIA',
'PB_ADI SC SAVANNAH',
'PB_ADI SC-NC FLORENCE-MYRTLE BEACH',
'PB_ADI TN CHATTANOOGA',
'PB_ADI TN JACKSON',
'PB_ADI TN NASHVILLE',
'PB_ADI TN-KY KNOXVILLE',
'PB_ADI VA CHARLOTTESVILLE',
'PB_ADI VA HARRISONBURG',
'PB_ADI VA RICHMOND-PETERSBURG',
'PB_ADI VA ROANOKE-LYNCHBURG',
'PB_ADI VA WASHINGTON DC',
'PB_ADI VA-NC NORFOLK-NEWPORT',
'PB_ADI WI GREEN BAY',
'PB_ADI WI MADISON',
'PB_ADI WI MILWAUKEE',
'PB_ADI WV BLUEFIELD BECKLEY OAK HILL',
'PB_ADI WV CLARKSBURG-WESTON',
'PB_ADI WV-OH-KY CHARLESTON-HUNTINGTON',
'1Location All State MN State Min',
'1Location All State MN Zone 1',
'1Location All State MN Zone 2',
'1Location All State MN Zone 3',
'1Location All State MN Zone 4',
'1Location All State MN Zone 5',
'1Location All State MN Zone 6',
'1Location All State SD SA',
'1Location All State WI SA'
)))
