...
on   icl.inventory_item_id = si.item_id
join Received_Supplier_Item as rsi
on   rsi.supplier_id = si.supplier_id
and  rsi.supplier_item_id = si.supplier_item_id
and  icl.business_unit_id = rsi.business_unit_id
