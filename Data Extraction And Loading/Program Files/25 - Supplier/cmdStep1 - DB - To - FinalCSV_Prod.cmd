...
SET ProcessName=Supplier
SET ProcessCode=SupplierExtract
...
SET FinalCSVDir=..\..\Import Files\Supplier\FinalCSV\
SET Server=MPC9504
SET DB=bcssa
...
SQLCmd -S %Server% -d %DB% -E -i %SQLExtractFile% -o "%FinalCSVDir%%ProcessName%-All Suppliers.csv" -s"," -W -w 4000
