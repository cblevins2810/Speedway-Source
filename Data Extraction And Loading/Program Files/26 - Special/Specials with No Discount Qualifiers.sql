...
WHERE EXISTS (SELECT 1 FROM retail_auto_combo_item_group_list AS racigl2
              WHERE racigl.retail_auto_combo_id = racigl2.retail_auto_combo_id
              AND   racigl2.discount_id IS NULL)
              
--WHERE rac.retail_auto_combo_id = 1158556
